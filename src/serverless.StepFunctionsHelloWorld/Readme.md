...
Execute unit tests
```
    cd "serverless.StepFunctionsHelloWorld/test/serverless.StepFunctionsHelloWorld.Tests"
    dotnet test
```

Deploy application
```
    cd "serverless.StepFunctionsHelloWorld/src/serverless.StepFunctionsHelloWorld"
